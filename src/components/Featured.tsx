	...
	return (
		<div className="w-screen overflow-x-scroll text-red-500 no-scrollbar">
			<div className="w-max flex">
				...
				<div key={item.id} className="w-screen h-[60vh] flex flex-col items-center justify-around p-4 hover:bg-fuchsia-50 transition-all duration-300 cursor-pointer md:w-[50vw] xl:w-[33vw] xl:h-[90vh]">
					...
					<div className="flex-1 flex flex-col items-center justify-center text-center gap-4 ">
						...
						<p className="p-4 2xl-p8">{item.desc}</p>
